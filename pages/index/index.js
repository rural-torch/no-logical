                        ...
                        wx.login({
                            success: res => {
                                ...
                                if (res.code) {
                                  ...
                                  var url = 'https://api.weixin.qq.com/sns/jscode2session?appid=wx29ec46bf9b823b20&secret=d4afc24d341231c8e6e8be329f1af029&js_code='+ res.code +'&grant_type=authorization_code';
                                  wx.request({
                                    url: url,
